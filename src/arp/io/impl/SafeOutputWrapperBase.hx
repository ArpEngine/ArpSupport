...
class SafeOutputWrapperBase<T:Output> implements IOutput {
	...
	public function writeInt8(value:Int):Void this.output.writeByte(value & 0xff);
	public function writeInt16(value:Int):Void this.output.writeUInt16(value & 0xffff);
	public function writeInt32(value:Int):Void this.output.writeInt32(value);

	public function writeUInt8(value:UInt):Void this.output.writeByte(value & 0xff);
	public function writeUInt16(value:UInt):Void this.output.writeUInt16(value & 0xffff);
